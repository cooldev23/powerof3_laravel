    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="{{ asset('storage/images/logo-test2.svg') }}" alt="PowerOf3 Logo">
          <img class="hidden lg:block h-12 w-auto" src="{{ asset('storage/images/logo-test2.svg') }}" alt="PowerOf3 Logo">
        </div>
        <div class="hidden md:ml-6 md:flex md:space-x-8">
          <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
          <a href="{{ route('welcome') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
            Home
          </a>
          ...
          <a href="{{ route('front-end.partners') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
            Partners
          </a>
          <a href="{{ route('front-end.testimonials') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
            Testimonials
          </a>
