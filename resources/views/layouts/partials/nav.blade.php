    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="{{ asset('images/logo-test2.svg') }}" alt="Workflow">
          <img class="hidden lg:block h-8 w-auto" src="{{ asset('images/logo-test2.svg') }}" alt="Workflow">
        </div>
