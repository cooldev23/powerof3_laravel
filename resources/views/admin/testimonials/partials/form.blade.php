<fieldset>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 mb-6">
        ...
        <div class="mb-4 mx-2 col-span-2">
            ...
            <textarea class="tiny-field appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-blue-500 shadow" rows="10" cols="30" name="content" id="content" placeholder="Testimonial content" >{{ old('content', $testimonial->content ? $testimonial->content : '') }}</textarea>
        </div>
    </div>
</fieldset>
