<x-layout>
    {{-- <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 pt-6"> --}}
        <x-form method="PUT" action="{{ route('admin.partners.update', array($partner)) }}" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-auto w-full lg:w-2/3 border">
