<header class="h-full bg-gradient-to-b from-primary-color to-transparent">
	<img class="hidden mx-auto lg:block h-48 w-auto" src="http://powerof3_laravel.test/storage/images/logo-test2.svg" alt="PowerOf3 Logo">
	<div class="relative -mt-4">
		<div class="relative max-w-7xl mx-auto">
			...
			<div class="mt-8 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
				<div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
					...
					<div class="flex-1 bg-white p-6 flex flex-col justify-between">
						<div class="flex-1">
							...
							<p class="text-2xl font-semibold text-gray-900">Homes</p>
				...
				<div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
					<div class="flex-shrink-0">
						<img class="h-48 w-full object-cover" src="{{ url('/storage/images/closeup_land.jpg') }}" alt="">
					</div>
					<div class="flex-1 bg-white p-6 flex flex-col justify-between">
						<div class="flex-1">
							<a href="#" class="block mt-2">
							<p class="text-2xl font-semibold text-gray-900">Land</p>
				...
				<div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
					<div class="flex-shrink-0">
						<img class="h-48 w-full object-cover" src="{{ url('/storage/images/rec-prop.jpg') }}" alt="">
					</div>
					<div class="flex-1 bg-white p-6 flex flex-col justify-between">
						<div class="flex-1">
							<a href="#" class="block mt-2">
							<p class="text-2xl font-semibold text-gray-900">Recreational Property</p>
